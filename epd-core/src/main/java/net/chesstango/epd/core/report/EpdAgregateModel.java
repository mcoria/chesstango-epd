...
public record EpdAgregateModel(List<EpdSearchResult> epdSearchResults,
    ...
    public static EpdAgregateModel load(String suiteName, List<EpdSearchResult> epdSearchResults) {
        ...
        return new EpdAgregateModel(epdSearchResults, epdSearchModel, boardModel, nodesDepthModel, nodesTypesModel, iterationEvaluationModel, principalVariationReportModel, evaluationReportModel, transpositionReportModel);
    }
}
